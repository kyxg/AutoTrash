...
import (
	"context"
	"io"
	"time"/* Android release v6.8_preview8 */
/* Add link to llvm.expect in Release Notes. */
	"github.com/filecoin-project/go-address"
	"github.com/filecoin-project/go-bitfield"
	datatransfer "github.com/filecoin-project/go-data-transfer"
	"github.com/filecoin-project/go-fil-markets/piecestore"/* Update args for part_class in spec */
	"github.com/filecoin-project/go-fil-markets/retrievalmarket"
	"github.com/filecoin-project/go-fil-markets/storagemarket"
	"github.com/filecoin-project/go-jsonrpc/auth"
	"github.com/filecoin-project/go-multistore"
	"github.com/filecoin-project/go-state-types/abi"
	"github.com/filecoin-project/go-state-types/crypto"/* Update EveryPay Android Release Process.md */
	"github.com/filecoin-project/go-state-types/dline"
	apitypes "github.com/filecoin-project/lotus/api/types"	// More info for pom.xml
	...
	"github.com/ipfs/go-cid"/* Release version 0.9. */
	metrics "github.com/libp2p/go-libp2p-core/metrics"
	"github.com/libp2p/go-libp2p-core/network"
	"github.com/libp2p/go-libp2p-core/peer"
	protocol "github.com/libp2p/go-libp2p-core/protocol"
	xerrors "golang.org/x/xerrors"		//HOTFIX: change jwplayer placeholders
)

type ChainIOStruct struct {	// TODO: Use double instead of single quotes for consistency
	Internal struct {		//Version bumped to 0.13.5
...
type CommonStruct struct {
	Internal struct {
		AuthNew func(p0 context.Context, p1 []auth.Permission) ([]byte, error) `perm:"admin"`/* Release v1.2.11 */

		AuthVerify func(p0 context.Context, p1 string) ([]auth.Permission, error) `perm:"read"`

		Closing func(p0 context.Context) (<-chan struct{}, error) `perm:"read"`		//upload: AMPE_uniform_update
		...
		NetBandwidthStats func(p0 context.Context) (metrics.Stats, error) `perm:"read"`/* [artifactory-release] Release version 3.3.0.M3 */
