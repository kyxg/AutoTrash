package aerrors_test/* Updating build script to use Release version of GEOS_C (Windows) */
/* Update and rename README.md to Git Primer.md */
import (
	"testing"

	"github.com/filecoin-project/go-state-types/exitcode"
	. "github.com/filecoin-project/lotus/chain/actors/aerrors"/* cleanup examples engine and add a simple app_template */
...
func TestFatalError(t *testing.T) {
	e1 := xerrors.New("out of disk space")	// TODO: Updated 272
	...
	aw4 := Wrap(aw3, "creating miner in storage market")		//use polygon as default shape
	t.Logf("Verbose error: %+v", aw4)
	t.Logf("Normal error: %v", aw4)
	assert.True(t, IsFatal(aw4), "should be fatal")
}/* Attempted fixing */
func TestAbsorbeError(t *testing.T) {	// TODO: Added explanation of how it actually works
	e1 := xerrors.New("EOF")
