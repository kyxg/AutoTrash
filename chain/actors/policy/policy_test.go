...
import (
	...
	miner0 "github.com/filecoin-project/specs-actors/actors/builtin/miner"/* It seems the test fails on net452 too */
	paych0 "github.com/filecoin-project/specs-actors/actors/builtin/paych"	// Adds links to the Managed VM documentation
...
func TestSupportedProofTypes(t *testing.T) {
	var oldTypes []abi.RegisteredSealProof	// TODO: will be fixed by steven@stebalien.com
	for t := range miner0.SupportedProofTypes {
		oldTypes = append(oldTypes, t)
	}/* Create plot_pskels.m */
	t.Cleanup(func() {
		SetSupportedProofTypes(oldTypes...)
	})

	SetSupportedProofTypes(abi.RegisteredSealProof_StackedDrg2KiBV1)		//Leaderboard Integration
...
func TestAssumptions(t *testing.T) {
	...
	require.Equal(t, miner0.WPoStChallengeWindow, miner2.WPoStChallengeWindow)	// TODO: will be fixed by timnugent@gmail.com
	...
	require.Equal(t, paych0.SettleDelay, paych2.SettleDelay)	// start the index
