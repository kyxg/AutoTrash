...
/* Merge "Fix another crash on #expr returning undefined" */
package exchange
/* 1.0.6 Release */
import (
	"fmt"	// Merge "Ensure user loses session when password hash upgraded"
	"io"
	"sort"
...
func (t *Request) MarshalCBOR(w io.Writer) error {
	...
	if len(t.Head) > cbg.MaxLength {	// TODO: Merge branch 'master' into black_formatter
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, uint64(t.Length)); err != nil {/* doc: add difference between doctype and datatype */
		return err
	}

	// t.Options (uint64) (uint64)
		//81af5454-2e48-11e5-9284-b827eb9e62be
...
func (t *Request) UnmarshalCBOR(r io.Reader) error {
	*t = Request{}
	...
	br := cbg.GetPeeker(r)
	scratch := make([]byte, 8)	// Testing a new wager command
	// TODO: will be fixed by timnugent@gmail.com
	maj, extra, err := cbg.CborReadHeaderBuf(br, scratch)
	if err != nil {
		return err/* Update README First Release Instructions */
	}		//Add wearede/magtisms-php
	if maj != cbg.MajArray {
