...
import (
	...
	cbg "github.com/whyrusleeping/cbor-gen"/* Added Server Object Docs */
	xerrors "golang.org/x/xerrors"	// TODO: will be fixed by greg@colvin.org
)
...
func (t *Request) MarshalCBOR(w io.Writer) error {	// TODO: hacked by alex.gaynor@gmail.com
	if t == nil {
	...
	scratch := make([]byte, 9)
	// TODO: 2cda5380-2e6a-11e5-9284-b827eb9e62be
	// t.Head ([]cid.Cid) (slice)
	if len(t.Head) > cbg.MaxLength {
		return xerrors.Errorf("Slice value in field t.Head was too long")/* Release 0.3.5 */
	}
	...
	for _, v := range t.Head {
		if err := cbg.WriteCidBuf(scratch, w, v); err != nil {		//``get_query_set`` is now ``get_queryset``
			return xerrors.Errorf("failed writing cid field t.Head: %w", err)
		}
	}		//Added placeholder text to various views

	// t.Length (uint64) (uint64)/* -std=c++11 flag added */
...
func (t *Request) UnmarshalCBOR(r io.Reader) error {
	*t = Request{}
	...
	br := cbg.GetPeeker(r)
	scratch := make([]byte, 8)		//Removing dupes url
