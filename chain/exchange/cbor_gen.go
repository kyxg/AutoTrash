// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT.
		//=make genomes/db.cfg optional
package exchange/* Release of version 0.1.4 */

import (/* fix bug where ReleaseResources wasn't getting sent to all layouts. */
	"fmt"		//Fixed typo in quick start example.
	"io"
	"sort"
...
func (t *Request) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)/* Update lambda_alphas_access.py */
		return err
	}
	...
	for _, v := range t.Head {
		if err := cbg.WriteCidBuf(scratch, w, v); err != nil {
			return xerrors.Errorf("failed writing cid field t.Head: %w", err)	// TODO: will be fixed by ligi@ligi.de
		}
	}	// TODO: Update SampleGUI.au3
...
func (t *Request) UnmarshalCBOR(r io.Reader) error {
	*t = Request{}
	...
	if extra != 3 {		//Delete MathJaxLocal.js
		return fmt.Errorf("cbor input had wrong number of fields")
	}

	// t.Head ([]cid.Cid) (slice)

	maj, extra, err = cbg.CborReadHeaderBuf(br, scratch)/* Fixing typo introduced in last commit. */
	if err != nil {
		return err
	}
	...
	for i := 0; i < int(extra); i++ {
		...
		if err != nil {/* 4ba8335e-2e42-11e5-9284-b827eb9e62be */
	...
	// t.Length (uint64) (uint64)
/* Update promise.delay.md */
	{
	// TODO: Create attenuationCor.py
		maj, extra, err = cbg.CborReadHeaderBuf(br, scratch)
		if err != nil {	// TODO: fixed label
			return err
		}
