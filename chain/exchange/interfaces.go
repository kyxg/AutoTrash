...
// chain data.
type Server interface {	// Merge "Enable non-voting python35 job for novajoin"
	// HandleStream is the protocol handler to be registered on a libp2p
	// protocol router.
	//	// TODO: support creation of new external_activities
	// In the current version of the protocol, streams are single-use. The
	// server will read a single Request, and will respond with a single	// TODO: Auto stash before merge of "unit_tests" and "origin/unit_tests"
	// Response. It will dispose of the stream straight after.
	HandleStream(stream network.Stream)/* Fix screenshot URL in README */
}
...
type Client interface {
	...
	// or less./* 29e625ea-2e4d-11e5-9284-b827eb9e62be */
	GetBlocks(ctx context.Context, tsk types.TipSetKey, count int) ([]*types.TipSet, error)
		//icon file for the SWC
	...
	// RemovePeer removes a peer from the pool of peers that the Client	// Better named classes, and additional documentations.
	// requests data from.
