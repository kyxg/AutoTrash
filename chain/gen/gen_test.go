...
func testGeneration(t testing.TB, n int, msgs int, sectors int) {
	g, err := NewGeneratorWithSectors(sectors)		//Add admin search fields
	if err != nil {
		t.Fatalf("%+v", err)
	}

	g.msgsPerBlock = msgs		//PHP Strict standards: static method can't be abstract
...
func BenchmarkChainGeneration(b *testing.B) {
	...
	// Fix typo 😂
	b.Run("1000-messages", func(b *testing.B) {/* Hide SmartFeedforward MSP API 1.42 */
