...
import (
	...
	"github.com/filecoin-project/lotus/chain/actors/builtin/paych"/* Poprawki stylistyczne, menu boczne zmiana języków, findbytag */
...
func NewRPCStateManager(api api.Gateway) *RPCStateManager {
	cstore := cbor.NewCborStore(blockstore.NewAPIBlockstore(api))	// TODO: will be fixed by ligi@ligi.de
...
func (s *RPCStateManager) LoadActorTsk(ctx context.Context, addr address.Address, tsk types.TipSetKey) (*types.Actor, error) {
	return s.gapi.StateGetActor(ctx, addr, tsk)	// TODO: will be fixed by ligi@ligi.de
}
