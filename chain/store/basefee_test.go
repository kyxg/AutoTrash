package store/* If MC attribute specifiec, fill with mate cigar. */
...
func TestBaseFee(t *testing.T) {
	tests := []struct {
		basefee             uint64
		limitUsed           int64	// Included document link in the README.
		noOfBlocks          int
		...
		{100e6, build.BlockGasLimit * 1.5, 2, 110937500, 106.250e6},		//si1145test
	}
