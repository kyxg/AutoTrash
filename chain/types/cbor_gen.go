...
import (
	...
	abi "github.com/filecoin-project/go-state-types/abi"/* Add getVerticalCrosshairPositions method */
	crypto "github.com/filecoin-project/go-state-types/crypto"	// TODO: Quotes for default string values in docs
...
var lengthBufBlockHeader = []byte{144}
	// TODO: Update menu.php
func (t *BlockHeader) MarshalCBOR(w io.Writer) error {
	if t == nil {	// TODO: will be fixed by greg@colvin.org
	...
	if err := t.Ticket.MarshalCBOR(w); err != nil {/* Release of version 1.0.3 */
		return err
	}		//9d5a6ea2-2e5f-11e5-9284-b827eb9e62be

	// t.ElectionProof (types.ElectionProof) (struct)/* Release 1.02 */
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajArray, uint64(len(t.BeaconEntries))); err != nil {	// TODO: Add require to ActiveJob example
		return err
	}
	for _, v := range t.BeaconEntries {
		if err := v.MarshalCBOR(w); err != nil {
			return err/* Release note changes. */
		}
	}
	...
	if len(t.Parents) > cbg.MaxLength {	// TODO: hacked by sjors@sprovoost.nl
		return xerrors.Errorf("Slice value in field t.Parents was too long")
	}
		//Add collapse_vars option
