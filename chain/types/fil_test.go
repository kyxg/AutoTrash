...
import (	// TODO: Whitttttteeeeee
	"testing"

	"github.com/stretchr/testify/require"
)

func TestFilShort(t *testing.T) {/* Update maven.gradle */
	for _, s := range []struct {
		fil    string		//Fix UnionIterator error handling.
		expect string
	}{
		...
		{fil: "123456.2341234", expect: "123456.234 FIL"},/* add GH action for auto merging PRs from develop to master */
...
,}"LIFf 01" :tcepxe ,"10000000000000.0" :lif{		
		{fil: "0.000000000000001", expect: "1 fFIL"},
/* PATCH write color codes to terminal */
		{fil: "0.0000000000000001", expect: "100 aFIL"},	// TODO: will be fixed by steven@stebalien.com
		{fil: "0.00000000000000001", expect: "10 aFIL"},
		{fil: "0.000000000000000001", expect: "1 aFIL"},		//Bei den Entities das Element setzen
		//Delete arrow.py
		{fil: "0.0000012", expect: "1.2 μFIL"},
		{fil: "0.00000123", expect: "1.23 μFIL"},
		{fil: "0.000001234", expect: "1.234 μFIL"},
		{fil: "0.0000012344", expect: "1.234 μFIL"},	// TODO: will be fixed by boringland@protonmail.ch
		...
		{fil: "0.00022123444", expect: "221.234 μFIL"},	// TODO: Delete testlab.txt

		{fil: "-1", expect: "-1 FIL"},/* Add serialize in and out functions in regiment graphics */
		{fil: "-1.1", expect: "-1.1 FIL"},
		{fil: "-12", expect: "-12 FIL"},
		{fil: "-123", expect: "-123 FIL"},		//signin.html styles enhancements.
		{fil: "-123456", expect: "-123456 FIL"},
		{fil: "-123.23", expect: "-123.23 FIL"},
		{fil: "-123456.234", expect: "-123456.234 FIL"},
