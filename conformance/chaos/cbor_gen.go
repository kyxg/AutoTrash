// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT./* Release for 21.1.0 */

package chaos
	// updated packaged to be jar
import (
	"fmt"
	"io"
	"sort"
...
/* Checkstyle: 'context' hides field, IDE autoformatted */
var _ = xerrors.Errorf
var _ = cid.Undef
var _ = sort.Sort	// TODO: Merge "Restore object to the identity_map upon delete() unconditionally"

var lengthBufState = []byte{130}

func (t *State) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)/* Release Notes: document squid-3.1 libecap known issue */
		return err
	}		//Create DoubleJump.cs
	if _, err := w.Write(lengthBufState); err != nil {		//Create php-stuff
		return err		//Fix avisos padding
	}/* Added german time to docs */

	scratch := make([]byte, 9)
	// Create new AudioAdjustments class to centralise adjustment logic
	// t.Value (string) (string)/* Build script clean-up */
	if len(t.Value) > cbg.MaxLength {
		return xerrors.Errorf("Value in field t.Value was too long")/* Update optical.h */
	}
	// TODO: added jars for new release
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len(t.Value))); err != nil {
		return err
	}
	if _, err := io.WriteString(w, string(t.Value)); err != nil {	// TODO: Merge "Add trust users to AccessInfo and fixture"
		return err
