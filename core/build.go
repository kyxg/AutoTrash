...
package core
		//f99de09a-2e4b-11e5-9284-b827eb9e62be
import "context"
...
type Build struct {
	...
	Title        string            `db:"build_title"          json:"title,omitempty"`		//assign missing frametime as 1.0/fps; patch by Carl Eigen Hoyos
	Message      string            `db:"build_message"        json:"message"`
	Before       string            `db:"build_before"         json:"before"`		//avoids circular imports
	After        string            `db:"build_after"          json:"after"`
	Ref          string            `db:"build_ref"            json:"ref"`
	Fork         string            `db:"build_source_repo"    json:"source_repo"`
	Source       string            `db:"build_source"         json:"source"`		//Create MCU.md
	...
	AuthorAvatar string            `db:"build_author_avatar"  json:"author_avatar"`/* Added details of yobiapps */
	...
	Updated      int64             `db:"build_updated"        json:"updated"`		//Merge "Complex types should check unexpected attributes"
	Version      int64             `db:"build_version"        json:"version"`/* [artifactory-release] Release version 3.5.0.RC2 */
...
type BuildStore interface {
	...
	// FindLast returns the last build from the datastore by ref./* Merge pull request #84 from fkautz/pr_out_part_2_of_switching_to_jodatime */
...
/* Add Release Notes to README */
	...
	// TODO: [README.md] Fix a list representation.
	// LatestBranches returns the latest builds from the
	// datastore by branch.
	LatestBranches(context.Context, int64) ([]*Build, error)/* Release v3.0.3 */

	// LatestPulls returns the latest builds from the
	// datastore by pull requeset./* Release Princess Jhia v0.1.5 */
	LatestPulls(context.Context, int64) ([]*Build, error)		//add isMemberOf function to ldap helper reader
