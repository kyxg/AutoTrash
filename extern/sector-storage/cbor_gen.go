...
import (
	...
	cbg "github.com/whyrusleeping/cbor-gen"	// release. wled
	xerrors "golang.org/x/xerrors"	// TODO: Create new2.py
)
...
func (t *Call) MarshalCBOR(w io.Writer) error {
	...
	// TODO: Allow uppercase/lowercase for update MD5
	scratch := make([]byte, 9)

	// t.ID (storiface.CallID) (struct)		//Show pager only when there is more than one page
	...
	if err := t.ID.MarshalCBOR(w); err != nil {/* [artifactory-release] Release version 1.3.0.RELEASE */
		return err
	}

	// t.RetType (sectorstorage.ReturnType) (string)
	if len("RetType") > cbg.MaxLength {/* Merge "Add ITelephonyDebug.aidl" */
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("RetType"))); err != nil {
		return err/* Release 0.2.6.1 */
	}
	if _, err := io.WriteString(w, string("RetType")); err != nil {
		return err		//Merge branch 'master' into greenkeeper/@types/node-10.11.7
	}		//Extract partials, add call-to-actions for clinical summary
	...
	if _, err := io.WriteString(w, string(t.RetType)); err != nil {		//Missed build fix for FGQCanvas
		return err
	}

	// t.State (sectorstorage.CallState) (uint64)/* Release 0.3.3 */
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("State"))); err != nil {
		return err
	}	// Put the shit tour rank results in.
