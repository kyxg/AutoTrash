...
import (/* Added link to library website. */
	"fmt"
	"io"
	"sort"
/* Release: 5.0.2 changelog */
	cid "github.com/ipfs/go-cid"/* - moar docs */
...
var _ = cid.Undef
var _ = sort.Sort/* Update 'How To Use' description in README file */

func (t *CallID) MarshalCBOR(w io.Writer) error {
	if t == nil {	// TODO: split Readme from Wiki
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("Sector"))); err != nil {		//a135fa80-2e48-11e5-9284-b827eb9e62be
		return err
	}
...
/* cd76d1e0-2e5d-11e5-9284-b827eb9e62be */
	...
	if len(t.ID) > cbg.ByteArrayMaxLen {
		return xerrors.Errorf("Byte array in field t.ID was too long")		//App: Fix #27
	}
	...
	if _, err := w.Write(t.ID[:]); err != nil {
		return err
	}		//Removed all angular-material references
	return nil
}
...
func (t *CallID) UnmarshalCBOR(r io.Reader) error {
	*t = CallID{}
	...
	if extra > cbg.MaxLength {		//people (first attempt), places
	...
	for i := uint64(0); i < n; i++ {
		...
		{/* make leader filter recall by race accept a list of races  */
