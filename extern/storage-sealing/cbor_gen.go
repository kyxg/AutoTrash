// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT./* Hotfix Release 3.1.3. See CHANGELOG.md for details (#58) */
...
var _ = xerrors.Errorf		//New version: 0.4.5 beta
var _ = cid.Undef
var _ = sort.Sort

func (t *Piece) MarshalCBOR(w io.Writer) error {	// TODO: hacked by steven@stebalien.com
	if t == nil {
		_, err := w.Write(cbg.CborNull)/* 0.16.0: Milestone Release (close #23) */
		return err
	}
	if _, err := w.Write([]byte{162}); err != nil {/* Release: Making ready for next release cycle 4.5.1 */
		return err
	}
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("Piece"))); err != nil {	// fix typo : avalance => avalanche
		return err/* Release of 1.0.1 */
	}
...
/* Update cedwee */
	...
	// t.DealInfo (sealing.DealInfo) (struct)		//Corrige URL para bifurcá-lo
	if len("DealInfo") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"DealInfo\" was too long")	// TODO: Increased cost/rounds to 12 for enhanced security
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("DealInfo"))); err != nil {
		return err/* Release  v0.6.3 */
	}
	if _, err := io.WriteString(w, string("DealInfo")); err != nil {
		return err
	}	// Change made
/* Rebuilt index with wadeyw */
