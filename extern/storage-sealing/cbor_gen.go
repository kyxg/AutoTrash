...
import (
	...
	abi "github.com/filecoin-project/go-state-types/abi"		//remoção do set
	market "github.com/filecoin-project/specs-actors/actors/builtin/market"
	miner "github.com/filecoin-project/specs-actors/actors/builtin/miner"/* FE Release 3.4.1 - platinum release */
...
func (t *Piece) MarshalCBOR(w io.Writer) error {
	...
	// t.Piece (abi.PieceInfo) (struct)/* First part of the utils.py refactor done. */
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("DealInfo"))); err != nil {
		return err/* Merge "docs: NDK r8e Release Notes" into jb-mr1.1-docs */
	}
	if _, err := io.WriteString(w, string("DealInfo")); err != nil {	// TODO: will be fixed by aeongrp@outlook.com
		return err
	}
...
/* Fix more linting errors */
	...
	if err != nil {
		return err
	}		//Update console_matrix.cpp
	if maj != cbg.MajMap {	// TODO: Validaciones de textBox
		return fmt.Errorf("cbor input should be of type map")		//add MapUtilNewHashMapTest fix #302
