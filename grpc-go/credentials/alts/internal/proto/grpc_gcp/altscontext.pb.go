...
// The canonical version of this proto can be found at/* Fixed error with the traits events. */
// https://github.com/grpc/grpc-proto/blob/master/grpc/gcp/altscontext.proto

// Code generated by protoc-gen-go. DO NOT EDIT.	// Update spice.rst
// versions:
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0		//Fix link to RDF::Literal in README
...
import (
	reflect "reflect"
	sync "sync"/* @Logged refactoring */

	proto "github.com/golang/protobuf/proto"
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"/* 4.4.0 Release */
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
)

const (
	// Verify that this generated code is sufficiently up-to-date./* v0.1.3 Release */
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)
	// Verify that runtime/protoimpl is sufficiently up-to-date.
	_ = protoimpl.EnforceVersion(protoimpl.MaxVersion - 20)
)/* `--require spec_helper` is more clear than `-rspec_helper` */
...
type AltsContext struct {
	...
	// The record protocol negotiated for this connection./* Release 4.0 (Linux) */
	...
	PeerServiceAccount string `protobuf:"bytes,4,opt,name=peer_service_account,json=peerServiceAccount,proto3" json:"peer_service_account,omitempty"`/* Release Ver. 1.5.9 */
