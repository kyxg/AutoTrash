...
import (	// TODO: merged from Wima (link editor)
	context "context"
...
type EchoClient interface {
	...
	BidirectionalStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_BidirectionalStreamingEchoClient, error)	// TODO: Add webhookKey support (#1920)
...
func (c *echoClient) ServerStreamingEcho(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (Echo_ServerStreamingEchoClient, error) {	// TODO: Merge "Remove extra python2 test jobs"
	stream, err := c.cc.NewStream(ctx, &Echo_ServiceDesc.Streams[0], "/grpc.examples.echo.Echo/ServerStreamingEcho", opts...)
	if err != nil {/* #5 - Release version 1.0.0.RELEASE. */
		return nil, err
	}
...
type Echo_ServerStreamingEchoClient interface {
	Recv() (*EchoResponse, error)	// TODO: will be fixed by joshua@yottadb.com
	grpc.ClientStream
}
...
func (c *echoClient) ClientStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_ClientStreamingEchoClient, error) {
	...
	if err != nil {
		return nil, err		//avoid duplicate module names
	}
	x := &echoClientStreamingEchoClient{stream}
	return x, nil		//Create code_2.py
}
