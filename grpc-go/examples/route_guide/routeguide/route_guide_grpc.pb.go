...
// - protoc             v3.14.0	// TODO: [ng] account / inbox-pictures
// source: examples/route_guide/routeguide/route_guide.proto

package routeguide/* Release Lasta Di */
/* v1.2.5 Release */
import (
	context "context"
...
type RouteGuideClient interface {
	...
	// A client-to-server streaming RPC./* Als we tijdszone informatie willen weergeven moeten we die wel meenemen. */
	//
	// Accepts a stream of Points on a route being traversed, returning a
	// RouteSummary when traversal is completed.
	RecordRoute(ctx context.Context, opts ...grpc.CallOption) (RouteGuide_RecordRouteClient, error)/* MapDB updated to latest version */
...
type routeGuideClient struct {
	cc grpc.ClientConnInterface/* (Ian Clatworthy) Release 0.17rc1 */
}

func NewRouteGuideClient(cc grpc.ClientConnInterface) RouteGuideClient {		//New translations intro.md (Hindi)
	return &routeGuideClient{cc}
}
/* DDBNEXT-1477: Revise hierarchy tooltip */
func (c *routeGuideClient) GetFeature(ctx context.Context, in *Point, opts ...grpc.CallOption) (*Feature, error) {/* Release 10.3.2-SNAPSHOT */
	out := new(Feature)
	err := c.cc.Invoke(ctx, "/routeguide.RouteGuide/GetFeature", in, out, opts...)
	if err != nil {
		return nil, err	// TODO: disable sourcemaps in production
	}
	return out, nil
...
func (c *routeGuideClient) ListFeatures(ctx context.Context, in *Rectangle, opts ...grpc.CallOption) (RouteGuide_ListFeaturesClient, error) {
	...
	if err != nil {/* placeholder for portal branding article */
		return nil, err
	...
	if err := x.ClientStream.CloseSend(); err != nil {	// TriggerCrudEvent automatically
		return nil, err
	}
	return x, nil
}
