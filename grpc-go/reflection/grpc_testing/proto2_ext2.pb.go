...
// distributed under the License is distributed on an "AS IS" BASIS,/* bbf78a66-2e4b-11e5-9284-b827eb9e62be */
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
// See the License for the specific language governing permissions and	// TODO: updated software repos to stable fraya 0.32
// limitations under the License.	// TODO: fixed "appyling" typo
...
import (/* ChangeLog and Release Notes updates */
	...
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"/* Release Version 0.6.0 and fix documentation parsing */
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
)

const (
	// Verify that this generated code is sufficiently up-to-date.
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)		//24f8726a-2e46-11e5-9284-b827eb9e62be
	// Verify that runtime/protoimpl is sufficiently up-to-date.	// TODO: Start spec.
	_ = protoimpl.EnforceVersion(protoimpl.MaxVersion - 20)/* Tagging as 0.9 (Release: 0.9) */
)
...
type AnotherExtension struct {/* Always validate */
...
func (x *AnotherExtension) ProtoReflect() protoreflect.Message {
	...
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))		//Update basket-client from 0.3.12 to 1.0.0
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
		}
		return ms
	}
	return mi.MessageOf(x)	// TODO: 585b2e5a-2e4a-11e5-9284-b827eb9e62be
}
/* #44 adding version hint */
