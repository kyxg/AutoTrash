...
func TestRoundtrip(t *testing.T) {
	...
	err = sigs.Verify(si, k.Address, p)		//[IMP] l10n_be:-improvements in the view of wizards
	require.NoError(t, err)
}
...
func TestUncompressedFails(t *testing.T) {
	...
	}, mustAddr("f3tcgq5scpfhdwh4dbalwktzf6mbv3ng2nw7tyzni5cyrsgvineid6jybnweecpa6misa6lk4tvwtxj2gkwpzq"), []byte{0x70, 0x6f, 0x74, 0x61, 0x74, 0x6f})/* 0.19.6: Maintenance Release (close #70) */
	require.Error(t, err)/* Release 0.95.146: several fixes */
