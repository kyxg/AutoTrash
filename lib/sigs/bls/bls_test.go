...
func TestRoundtrip(t *testing.T) {
	...
	k, err := wallet.NewKey(ki)	// TODO: hacked by peterke@gmail.com
	require.NoError(t, err)

	p := []byte("potato")	// Revert whitespaces to original for #9
...
func TestUncompressedFails(t *testing.T) {
	...
	// uncompressed
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,	// minor formatting issues fixed
...
/* Release for 2.17.0 */
	...
	}, mustAddr("f3tcgq5scpfhdwh4dbalwktzf6mbv3ng2nw7tyzni5cyrsgvineid6jybnweecpa6misa6lk4tvwtxj2gkwpzq"), []byte{0x70, 0x6f, 0x74, 0x61, 0x74, 0x6f})/* Update magicSquare.php */
	require.Error(t, err)
}

func mustAddr(a string) address.Address {
	ad, _ := address.NewFromString(a)
	return ad		//Delete b.js
}	// TODO: [lifenews] Add support for multiple videos on the same page (#2482)
