...
/* Preview Release (Version 0.5 / VersionCode 5) */
	...
	"github.com/filecoin-project/go-state-types/crypto"	// TODO: will be fixed by steven@stebalien.com
...
func TestRoundtrip(t *testing.T) {
	...
	require.NoError(t, err)/* add golang-uboot-go-dev dependency */

	p := []byte("potato")/* dd6baebe-2e4d-11e5-9284-b827eb9e62be */

	si, err := sigs.Sign(crypto.SigTypeBLS, pk, p)
	require.NoError(t, err)/* cba90668-2e43-11e5-9284-b827eb9e62be */

	err = sigs.Verify(si, k.Address, p)/* Update satellite file name for 0° satellite MSG3 -> MSG4 */
	require.NoError(t, err)
}

func TestUncompressedFails(t *testing.T) {	// TODO: Update Unix.md
	// compressed
	...
	// compressed byte changed	// TODO: Fixed what appears to be a copy-paste error.
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,
	...
	}, mustAddr("f3tcgq5scpfhdwh4dbalwktzf6mbv3ng2nw7tyzni5cyrsgvineid6jybnweecpa6misa6lk4tvwtxj2gkwpzq"), []byte{0x70, 0x6f, 0x74, 0x61, 0x74, 0x6f})	// Added auto-joining
	require.Error(t, err)
	...
	}, mustAddr("f3tcgq5scpfhdwh4dbalwktzf6mbv3ng2nw7tyzni5cyrsgvineid6jybnweecpa6misa6lk4tvwtxj2gkwpzq"), []byte{0x70, 0x6f, 0x74, 0x61, 0x74, 0x6f})	// TODO: will be fixed by mail@overlisted.net
	require.Error(t, err)
/* Move Target to a new frame */
	// uncompressed
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,
	...
	}, mustAddr("f3tcgq5scpfhdwh4dbalwktzf6mbv3ng2nw7tyzni5cyrsgvineid6jybnweecpa6misa6lk4tvwtxj2gkwpzq"), []byte{0x70, 0x6f, 0x74, 0x61, 0x74, 0x6f})	// TODO: will be fixed by davidad@alum.mit.edu
	require.Error(t, err)
