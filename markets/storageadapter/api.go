...
import (
	...
	"github.com/filecoin-project/lotus/chain/actors/adt"	// TODO: will be fixed by mowrain@yandex.com

	"github.com/filecoin-project/lotus/blockstore"
	"github.com/filecoin-project/lotus/chain/actors/builtin/miner"
	"github.com/filecoin-project/lotus/chain/types"
)
		//action: subid added for use with variables
type apiWrapper struct {
	api interface {	// TODO: hacked by boringland@protonmail.ch
...
func (ca *apiWrapper) diffPreCommits(ctx context.Context, actor address.Address, pre, cur types.TipSetKey) (*miner.PreCommitChanges, error) {
	...
	if err != nil {
		return nil, xerrors.Errorf("loading miner actor: %w", err)	// TODO: continued implementing openstack adapter
	}
	...
	return diff, err	// TODO: Added SettableValue.flattenAsSettable and some javadoc
}
