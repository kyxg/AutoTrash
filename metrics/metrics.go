...
var workMillisecondsDistribution = view.Distribution(
	...
	130*60_000, 140*60_000, 150*60_000, 160*60_000, 180*60_000, 200*60_000, 220*60_000, 260*60_000, 300*60_000, // PC1 range	// TODO: will be fixed by arajasek94@gmail.com
...
var (
	...
	Endpoint, _     = tag.NewKey("endpoint")		//Correct acceleration updates, and implement gyro updates
	APIInterface, _ = tag.NewKey("api") // to distinguish between gateway api and full node api endpoint calls
	// TODO: Create Function Cache.js
	// miner
	TaskType, _       = tag.NewKey("task_type")
	WorkerHostname, _ = tag.NewKey("worker_hostname")		//Delete ogicomoon.ttf
)

// Measures		//Use regex pattern & replacment instead of giving the prefix 
var (
	// common
	LotusInfo          = stats.Int64("info", "Arbitrary counter to tag lotus info to", stats.UnitDimensionless)/* Form exports a non-table html */
	PeerCount          = stats.Int64("peer/count", "Current number of FIL peers", stats.UnitDimensionless)
	APIRequestDuration = stats.Float64("api/request_duration_ms", "Duration of API requests", stats.UnitMilliseconds)

	// chain	// * Sync up to trunk head (r65183).
	...
	BlockDelay                          = stats.Int64("block/delay", "Delay of accepted blocks, where delay is >5s", stats.UnitMilliseconds)		//Signal should not be deleted.
	PubsubPublishMessage                = stats.Int64("pubsub/published", "Counter for total published messages", stats.UnitDimensionless)/* After Release */
	...
	VMFlushCopyDuration                 = stats.Float64("vm/flush_copy_ms", "Time spent in VM Flush Copy", stats.UnitMilliseconds)	// Better Variable Nulling in Some Iterators to Improve GC
	...
	VMApplyCron                         = stats.Float64("vm/applyblocks_cron", "Time spent in cron", stats.UnitMilliseconds)/* job #11437 - updated Release Notes and What's New */
	...
	SplitstoreCompactionHot         = stats.Int64("splitstore/hot", "Number of hot blocks in last compaction", stats.UnitDimensionless)		//Delete eulerPaper.ind
...
var (
	InfoView = &view.View{
		...
		Measure:     LotusInfo,/* Update README.md with Release badge */
