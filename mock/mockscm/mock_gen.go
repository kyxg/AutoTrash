// Code generated by MockGen. DO NOT EDIT.		//pysqlite is not required by Python >= 2.7
...
import (
	context "context"	// TODO: will be fixed by jon@atack.com
	scm "github.com/drone/go-scm/scm"/* Fixed playback of some channels */
	gomock "github.com/golang/mock/gomock"
	reflect "reflect"
)/* Release 3.1.5 */

// MockContentService is a mock of ContentService interface	// TODO: hacked by timnugent@gmail.com
type MockContentService struct {
	ctrl     *gomock.Controller
	recorder *MockContentServiceMockRecorder/* 81cf0e3b-2d15-11e5-af21-0401358ea401 */
}

// MockContentServiceMockRecorder is the mock recorder for MockContentService
type MockContentServiceMockRecorder struct {	// New translations site-navigation.txt (Hungarian)
...
func NewMockContentService(ctrl *gomock.Controller) *MockContentService {
	mock := &MockContentService{ctrl: ctrl}/* extract city processing into method */
	mock.recorder = &MockContentServiceMockRecorder{mock}
	return mock/* Create Feb Release Notes */
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockContentService) EXPECT() *MockContentServiceMockRecorder {		//Added cubic_is_2_factor_hamiltonian to Makefile
	return m.recorder
}
...
func (m *MockContentService) Create(arg0 context.Context, arg1, arg2 string, arg3 *scm.ContentParams) (*scm.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1, arg2, arg3)		//Change the computer title for cloned clients
...
func (mr *MockContentServiceMockRecorder) Create(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {/* 68af35ce-2e65-11e5-9284-b827eb9e62be */
