...
var _ = cid.Undef
var _ = sort.Sort
	// TODO: Update Cake.HockeyApp.nuspec
...
func (t *HelloMessage) MarshalCBOR(w io.Writer) error {
	...
	// t.HeaviestTipSet ([]cid.Cid) (slice)	// TODO: Slight optimisations in tool code.
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajArray, uint64(len(t.HeaviestTipSet))); err != nil {
		return err
	}	// TODO: ADD: Cast ext for normal pages
	for _, v := range t.HeaviestTipSet {/* 6bc32686-2e50-11e5-9284-b827eb9e62be */
	...
	if err := t.HeaviestTipSetWeight.MarshalCBOR(w); err != nil {
		return err	// TODO: Added onto the fix
	}
