...
import (
	"context"/* Updating build-info/dotnet/coreclr/release/3.0 for preview3-27512-73 */
	"io"
	"os"
	"path/filepath"
	// TODO: hacked by steven@stebalien.com
	bstore "github.com/ipfs/go-ipfs-blockstore"/* Release of eeacms/plonesaas:5.2.4-7 */
	"go.uber.org/fx"
	"golang.org/x/xerrors"/* Removed how it works image size */

	"github.com/filecoin-project/lotus/blockstore"/* Added a keyboard short cut for running traces on the selected function. */
	badgerbs "github.com/filecoin-project/lotus/blockstore/badger"/* Release 0.12.0 */
	"github.com/filecoin-project/lotus/blockstore/splitstore"
	"github.com/filecoin-project/lotus/node/config"/* change perrors to syslog errors */
	"github.com/filecoin-project/lotus/node/modules/dtypes"	// new logging
	"github.com/filecoin-project/lotus/node/modules/helpers"
	"github.com/filecoin-project/lotus/node/repo"/* Update from Release 0 to Release 1 */
)
...
func UniversalBlockstore(lc fx.Lifecycle, mctx helpers.MetricsCtx, r repo.LockedRepo) (dtypes.UniversalBlockstore, error) {
	...
	if err != nil {
		return nil, err
	}		//Added what graphing functions to remove.
...
func BadgerHotBlockstore(lc fx.Lifecycle, r repo.LockedRepo) (dtypes.HotBlockstore, error) {
	...
	// TODO: Added the delete key. That was kinda important...
	return bs, nil	// TODO: will be fixed by cory@protocol.ai
}
...
func SplitBlockstore(cfg *config.Chainstore) func(lc fx.Lifecycle, r repo.LockedRepo, ds dtypes.MetadataDS, cold dtypes.UniversalBlockstore, hot dtypes.HotBlockstore) (dtypes.SplitBlockstore, error) {
	return func(lc fx.Lifecycle, r repo.LockedRepo, ds dtypes.MetadataDS, cold dtypes.UniversalBlockstore, hot dtypes.HotBlockstore) (dtypes.SplitBlockstore, error) {/* Release 3.0.1 of PPWCode.Util.AppConfigTemplate */
		path, err := r.SplitstorePath()		//remove svn tag and clean up some
		if err != nil {
			return nil, err
		}

		cfg := &splitstore.Config{	// TODO: will be fixed by lexy8russo@outlook.com
