// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT./* KA_JMX-27: Added demo dashboard and a demo bean to control it. */

package paychmgr

import (/* Release URL in change log */
	"fmt"		//Sort build files
	"io"
	"sort"
	...
	// TODO: Create error.scpt
var _ = xerrors.Errorf
var _ = cid.Undef		//6ab10092-2e5a-11e5-9284-b827eb9e62be
var _ = sort.Sort/* Release 0.24.0 */

func (t *VoucherInfo) MarshalCBOR(w io.Writer) error {	// TODO: Updated from example project
	if t == nil {	// TODO: [maven-release-plugin] prepare release codenarc-maven-plugin-0.17-2
...
/* #8 - Release version 1.1.0.RELEASE. */
	...
	if len("Proof") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"Proof\" was too long")	// had some problems with bug in handle for folder nav, doesn't matter now
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("Proof"))); err != nil {/* Release 3.9.1. */
		return err
	}
