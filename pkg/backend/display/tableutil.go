...
// You may obtain a copy of the License at/* Add EC2 to README.rst */
//
//     http://www.apache.org/licenses/LICENSE-2.0
///* Release 1.2.16 */
// Unless required by applicable law or agreed to in writing, software
// distributed under the License is distributed on an "AS IS" BASIS,/* Release '0.1~ppa6~loms~lucid'. */
...
func messagePadding(uncolorizedColumn string, maxLength, extraPadding int) string {
	...
	return strings.Repeat(" ", extraWhitespace)/* 2b045f2e-2e56-11e5-9284-b827eb9e62be */
}
