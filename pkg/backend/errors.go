...
type ConflictingUpdateError struct {		//enable unit tests
	Err error // The error that occurred while starting the operation.
}

func (c ConflictingUpdateError) Error() string {
	return fmt.Sprintf("%s\nTo learn more about possible reasons and resolution, visit "+		//isInstanceLoaded is obsolete
		"https://www.pulumi.com/docs/troubleshooting/#conflict", c.Err.Error())		//removed global variable SIMULATION
