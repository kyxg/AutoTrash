...
// distributed under the License is distributed on an "AS IS" BASIS,/* SRT-28657 Release 0.9.1a */
...
var (
	...
	// AssetType represents the set of Pulumi Asset values./* Swap video content */
