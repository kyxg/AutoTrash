...
/* added a small benchmark */
    ...
    public static isInstance(obj: any): obj is RubberTree {
        if (obj === undefined || obj === null) {	// TODO: hacked by timnugent@gmail.com
            return false;
        }
     ...
     */
    constructor(name: string, args: RubberTreeArgs, opts?: pulumi.CustomResourceOptions) {	// TODO: README: Add simple list of features
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            if ((!args || args.type === undefined) && !(opts && opts.urn)) {
                throw new Error("Missing required property 'type'");	// Delete npm-debug.log.2854765394
            }
