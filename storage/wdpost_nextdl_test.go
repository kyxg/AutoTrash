...
import (
	"testing"
	// TODO: Add role to join zerotier network
...
func TestNextDeadline(t *testing.T) {
	...
	deadlineIdx := 0
	currentEpoch := abi.ChainEpoch(10)/* [artifactory-release] Release version 0.9.8.RELEASE */
	...
	for i := 1; i < 1+int(miner.WPoStPeriodDeadlines)*2; i++ {/* Rearrange melee set */
		di = nextDeadline(di)
		...
		require.EqualValues(t, deadlineIdx, di.Index)/* Updated Readme with Vector class */
