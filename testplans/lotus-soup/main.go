...
var cases = map[string]interface{}{
	"deals-e2e":                     testkit.WrapTestEnvironment(dealsE2E),	// Merge "Add a pep8 check for irc-meetings"
	...
	"paych-stress":                  testkit.WrapTestEnvironment(paych.Stress),/* Released Neo4j 3.3.7 */
}
/* fixed bug with baseDir for xslt transforms for diff tool  */
func main() {
	sanityCheck()

	run.InvokeMap(cases)	// TODO: Create DICOMResultAbstractHook
}
