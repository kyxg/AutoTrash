...
// You may obtain a copy of the License at		//Merge branch 'develop' into autocomplete
//
//     http://www.apache.org/licenses/LICENSE-2.0/* Update DATAMODEL.md */
//
...
const b = new Resource("b", { fail: 1 }, { dependsOn: a });/* Trying workaround on Travis SecureRandom timeout */
